                ...
                <div class="form-body">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="email" class="form-control" name="email" placeholder="Email Address" id="first-name-icon" required>
                                <div class="form-control-icon">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="number" class="form-control" name="amount" placeholder="100 Pesos" id="city-id-icon" required>
                                <div class="form-control-icon">
                                    <i>P</i>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                            <label for="first-name-icon">Trainer Name</label>
                                    ...
                                    <fieldset class="form-group">
                                        <select name="trainer_id" class="form-select" id="basicSelect" required>
                                        ...
                                        while($trow = $tquery->fetch_assoc()){
                                            echo "
                                            <option value='".$trow['user_id']."'>".$trow['fname'].' '.$trow['mname'].' '.$trow['lname']."</option>
                                            ";
                                        }
                                        ?>
                                        </select>
