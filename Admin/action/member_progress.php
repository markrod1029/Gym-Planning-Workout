...
$qry1 = "INSERT INTO current_weight(initial_weight,current_weight,member_id,date) 
values ('$ini_weight','$curr_weight','$id',NOW())";
$result1 = mysqli_query($conn,$qry1); //query executes
if($conn->query($qry)){
