        ...
        <div class="card">
            ...
            <form class="form form-vertical" action="action/member_progress.php" method="POST">
                <div class="form-body">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            <label for="first-name-icon">Service Taken</label>
                            <div class="position-relative">
                                <input type="text" class="form-control" name="fullname" value="<?php echo $row['services']; ?>" placeholder="FullName" readonly>
                                <div class="form-control-icon">
