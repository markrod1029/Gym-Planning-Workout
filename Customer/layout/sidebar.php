...
<body>
    ...
    <div class="sidebar-menu">
        ...
        <p class='sidebar-title ' style="margin-bottom:-5px; text-align:center;"><?php echo $user['fname'].' '.$user['mname'].' '.$user['lname'] ?></p>
                ...
                <li class="sidebar-item  <?php if($page=='attendance'){ echo 'active'; }?> ">
                ...
                <li class="sidebar-item  <?php if($page=='announce'){ echo 'active'; }?>">
                    <a href="annocement.php" class='sidebar-link'>
