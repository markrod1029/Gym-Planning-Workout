                ...
                <div class="form-body">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" value='<?php echo $row['ini_weight']; ?>' name="ini_weight" placeholder="Weight" id="city-id-icon" required>
                                <div class="form-control-icon">
                                    <i >(kG)</i>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" value='<?php echo $row['curr_weight']; ?>'  name="curr_weight" placeholder="Weight" id="city-id-icon" required>
                                <div class="form-control-icon">
                                    <i >(kG)</i>
                                </div>
                            </div>
