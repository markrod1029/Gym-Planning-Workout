...
<div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control"name="password" placeholder="**********" value='<?php echo $row['password']; ?>'  id="first-name-icon" required>
                                <div class="form-control-icon">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" name="contact" value='<?php echo $row['contact']; ?>' placeholder="9876543210" id="mobile-id-icon" required>
                                <div class="form-control-icon">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" name="amount" value='<?php echo $row['amount']; ?>' placeholder="100 Pesos" id="city-id-icon" required>
                                <div class="form-control-icon">
                                    <i>P</i>
                                </div>
                            </div>
