...
<html>
  ...
  <div class="form-group btn-container">
    ...
    <input type="submit" name="login" id="submit" value="SIGN IN" class="btn btn-secondary btn-block mb-3" style="background:#2b2b72; border-color:#2b2b72; font-size:18px;">
  </div>
